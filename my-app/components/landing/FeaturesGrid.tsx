...
const features: { icon: IconName; accent: string; bg: string; title: string; desc: string; tag: string; href?: string; soon?: boolean }[] = [
  ...
  },
  {
    ...
    accent: 'var(--red)',
    bg: 'var(--red-bg)',
    title: 'Berita Jepang Asli',
    desc: 'Baca berita dari NHK Web Easy langsung di sini. Tiap artikel punya judul terjemahan Indonesia, tanda level JLPT, dan tautan ke sumber aslinya.',
    tag: 'NHK Web Easy · Bertanda Level',
  },
  {
    icon: 'building',
    accent: 'var(--gold)',
  ...
  },
  {
    ...
    desc: 'Cerita percakapan sehari-hari dari N5 hingga bisnis, lengkap dengan furigana, romaji, dan terjemahan Indonesia. Bisa diputar dengan suara AI, atur kecepatan, dan beri jeda untuk menirukan.',
    tag: 'Dialog · Suara AI · Shadowing',
  },
  {
    icon: 'reading',
    accent: 'var(--red)',
    ...
    desc: 'Bacaan level N5–N1 dengan furigana, terjemahan per kalimat, catatan kosakata penting, dan soal pemahaman bergaya JLPT.',
    tag: 'N5 → N1 · Gaya JLPT',
  },
  {
    icon: 'cards',
