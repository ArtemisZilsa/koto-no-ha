  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontSize: '240px', color: 'rgba(255,255,255,0.025)' }}
        aria-hidden="true"
      >
        言
      </div>

      <h2 className="font-serif text-[42px] font-semibold leading-tight mb-3 relative" style={{ color: 'var(--paper)' }}>
        Mulai Perjalananmu Hari Ini
      </h2>
      <p className="text-[15px] mb-9 relative" style={{ color: 'rgba(247,242,234,0.55)' }}>
